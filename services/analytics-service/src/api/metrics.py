...
async def get_call_metrics(
    ...
    return await call_agg.compute(start_date=start_date, end_date=end_date)
...
async def get_agent_metrics(
    ...
    return await agent_agg.compute(start_date=start_date, end_date=end_date)
...
async def get_lead_metrics(
    ...
    return await lead_agg.compute(start_date=start_date, end_date=end_date)
